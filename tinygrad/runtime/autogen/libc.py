...
try:
    ...
    pass
_SYS_IOCTL_H = 1 # macro
try:
    ioctl = _libraries['libc'].ioctl
...
__all__ = \
    ...
    '_SYS_IOCTL_H', '_SYS_MMAN_H', '_UNISTD_H', '_XOPEN_ENH_I18N',
    ...
    'intptr_t', 'ioctl', 'isatty', 'lchown', 'link', 'linkat',
    'locale_t', 'lockf', 'lseek', 'madvise', 'memccpy', 'memchr',
    'memcmp', 'memcpy', 'memmem', 'memmove', 'mempcpy', 'memset',
